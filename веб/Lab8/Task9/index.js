...
document.getElementById("chk").onclick = () => {
    ...
    Усі елементи позитивні:${AllIsPositive(arr)}
    Хоча б один елемент позитивний:${OneIsPositive(arr)}`
}
...
document.getElementById("srch").onclick = () => {
    ...
    document.getElementById("resultCopy").innerHTML = res;
}
